...
ENT.PrintName = "Бронированная Неко"
...
ENT.RangeAttackRange = 1100
ENT.RangeAttackMinRange = 0
ENT.RangeAttackCooldown = 1.0
ENT.RangeAttackDamage = 8
...
ENT.UseWeapons = true
ENT.Weapons = { "weapon_shotgun" }   -- ⚡️ Только дробовик
